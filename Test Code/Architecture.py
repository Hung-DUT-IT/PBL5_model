...
# from keras.layers import Conv2D, Activation, Input, MaxPooling2D, Flatten, Dense, Dropout, BatchNormalization, Concatenate, Lambda, add, GlobalAveragePooling2D, Convolution2D, LocallyConnected2D, ZeroPadding2D, concatenate, AveragePooling2D
...
# def conv2d_bn(x, filters, kernel_size, strides=1, padding='same', use_bias=False, axis =3, momentum=0.995, epsilon=0.001, scale=False, activation='relu'):
#     """
...
#     x = BatchNormalization(axis = axis, momentum = momentum, epsilon = epsilon, scale = scale)(x)
	    
#     x = Activation(activation)(x) 
#     return x

# def stem_block(x):
# 	x = conv2d_bn(x, filters= 32, kernel_size= 3, strides=2, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')	
# 	x = conv2d_bn(x, filters= 32, kernel_size= 3, strides=1, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')	
# 	x = conv2d_bn(x, filters= 64, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')		
	
# 	branch_0 = MaxPooling2D((3, 3), strides=(2, 2))(x)
# 	branch_1 = conv2d_bn(x, filters= 96, kernel_size= 3, strides=2, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

# 	x = Concatenate(axis=3 )([branch_0, branch_1])

# 	branch_0 = conv2d_bn(x, filters= 64, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 	branch_0 = conv2d_bn(branch_0, filters= 96, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
	
# 	branch_1 = conv2d_bn(x, filters= 64, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 	branch_1 = conv2d_bn(branch_1, filters= 64, kernel_size= [1,7], strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 	branch_1 = conv2d_bn(branch_1, filters= 64, kernel_size= [7,1], strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 	branch_1 = conv2d_bn(branch_1, filters= 96, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 	x = Concatenate(axis=3 )([branch_0, branch_1])

# 	branch_0 = MaxPooling2D(1, strides=(2, 2))(x)
# 	branch_1 = conv2d_bn(x, filters= 192, kernel_size= 3, strides=2, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')	

# 	return Concatenate(axis=3)([branch_0, branch_1])

# def inception_resnet_a(x):
# 	# 5x Block35 (Inception-ResNet-A block):
# 	for _ in range(5):
# 		branch_0 = conv2d_bn(x, filters= 32, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
		
# 		branch_1 = conv2d_bn(x, filters= 32, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		branch_1 = conv2d_bn(branch_1, filters= 32, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

# 		branch_2 = conv2d_bn(x, filters= 32, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		branch_2 = conv2d_bn(branch_2, filters= 48, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		branch_2 = conv2d_bn(branch_2, filters= 64, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		mixed = Concatenate(axis=3 )([branch_0, branch_1, branch_2])
# 		up = Conv2D(384, 1, strides=1, padding='same', use_bias=True) (mixed)
...
# 	for _ in range(10):
# 		branch_0 = conv2d_bn(x, filters= 192, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
		
# 		branch_1 = conv2d_bn(x, filters= 128, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		branch_1 = conv2d_bn(branch_1, filters= 160, kernel_size= (1,7), strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		branch_1 = conv2d_bn(branch_1, filters= 192, kernel_size= (7,1), strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

# 		mixed = Concatenate(axis=3)([branch_0, branch_1])
# 		up = Conv2D(1024, 1, strides=1, padding='same', use_bias=True) (mixed)
...
# 	branch_0 = conv2d_bn(x, filters= 384, kernel_size= 3, strides=2, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

# 	branch_1 = conv2d_bn(x, filters= 192, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 	branch_1 = conv2d_bn(branch_1, filters= 224, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 	branch_1 = conv2d_bn(branch_1, filters= 256, kernel_size= 3, strides=2, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

# 	return Concatenate(axis=3)([branch_0, branch_1, branch_pool])

# def reduction_b(x):
	# 	# Mixed 7a (Reduction-B block): 8 x 8 x 2080	
	# 	branch_pool = MaxPooling2D(3, strides=2, padding='valid', name='Mixed_7a_Branch_3_MaxPool_1a_3x3')(x)

	# 	branch_0 = conv2d_bn(x, filters= 256, kernel_size= 1, strides=1, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
	# 	branch_0 = conv2d_bn(branch_0, filters= 384, kernel_size= 3, strides=2, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

	# 	branch_1 = conv2d_bn(x, filters= 256, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
	# 	branch_1 = conv2d_bn(branch_1, filters= 256, kernel_size= 3, strides=2, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

	# 	branch_2 = conv2d_bn(x, filters= 256, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
	# 	branch_2 = conv2d_bn(branch_2, filters= 256, kernel_size= 3, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
	# 	branch_2 = conv2d_bn(branch_2, filters= 256, kernel_size= 3, strides=2, padding='valid', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

	# 	return Concatenate(axis=3)([branch_0, branch_1, branch_2, branch_pool])
...
# 		branch_1 = conv2d_bn(x, filters= 192, kernel_size= 1, strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		branch_1 = conv2d_bn(branch_1, filters= 224, kernel_size= (1,3), strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')
# 		branch_1 = conv2d_bn(branch_1, filters= 256, kernel_size= (3,1), strides=1, padding='same', use_bias= False, axis=3, momentum=0.995, epsilon=0.001, scale=False, activation='relu')

# 		mixed = Concatenate(axis=3)([branch_0, branch_1])
# 		up = Conv2D(1920, 1, strides=1, padding='same', use_bias=True) (mixed)
# 		up = Lambda(scaling, output_shape=K.int_shape(up)[1:], arguments={'scale': 0.1})(up)
# 		x = add([x, up])
# 		x = Activation('relu')(x)
# 	return x	
...
# 		# Bottleneck
# 	x = Dense(256, use_bias=False, activation='softmax')(x)
